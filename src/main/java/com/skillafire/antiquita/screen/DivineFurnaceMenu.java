...
public class DivineFurnaceMenu extends AbstractContainerMenu {
	...
	public DivineFurnaceMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
		this(containerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()),
				new SimpleContainerData(DivineFurnaceBlockEntity.DATA_AMOUNT));
	}
	...
	private static final int TE_INVENTORY_SLOT_COUNT = DivineFurnaceBlockEntity.SLOT_NUMBER; // must be the number of
																								// slots you have!
